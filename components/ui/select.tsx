...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "bg-background px-4 py-2 text-sm ring-offset-background placeholder:text-muted-foreground",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-popover text-popover-foreground shadow-card-md",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-sm outline-none focus:bg-muted focus:text-foreground",
